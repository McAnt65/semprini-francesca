      ...
      <div className="mx-auto w-full max-w-[430px] py-0 sm:py-3">
        <div className="relative w-full overflow-hidden sm:rounded-[28px]">
          ...
          <button
            ...
            className="absolute left-[20.2%] top-[54.28%] z-30 flex h-[4.9%] w-[26.4%] items-center justify-center bg-transparent font-field-label text-[clamp(10px,2.5vw,13px)] leading-none text-[#6f1723]"
          >
            Carica immagine
          </button>
          ...
          <button
            ...
            className="absolute left-[20.2%] top-[60.18%] z-30 flex h-[4.9%] w-[26.4%] items-center justify-center bg-transparent font-field-label text-[clamp(10px,2.5vw,13px)] leading-none text-[#6f1723] disabled:opacity-60"
          >
            Acquerello
          </button>
